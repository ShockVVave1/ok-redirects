...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='redirect',
            name='languages',
            field=ok_redirects.fields.MultipleChoiceArrayField(base_field=models.CharField(blank=True, choices=[('tg', 'Tajik'), ('ru', 'Russian'), ('en', 'English')], max_length=10), blank=True, default=['tg', 'ru', 'en'], size=None, verbose_name='Languages to check redirect'),
        ),
        migrations.AlterField(
            model_name='redirect',
            name='to_language',
